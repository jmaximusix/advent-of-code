...
part1 = sum . zipWith (*) [1 ..] . map (crackGeodes 24 . readBlueprint)
part2 = product . map (crackGeodes 32) . take 3 . map readBlueprint

crackGeodes :: Int -> M44 Int -> Int
crackGeodes n blueprint =
  maximum $
